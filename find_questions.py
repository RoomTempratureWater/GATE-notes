...
try:
    ...
    if matches:
        ...
        with open(r'd:\GATE2027\GATE-notes\TOC\long\Finite_Automata_Long.md', 'a', encoding='utf-8') as f:
            f.write(markdown_content)
        with open(r'd:\GATE2027\GATE-notes\TOC\short\Finite_Automata_Short.md', 'a', encoding='utf-8') as f:
            f.write(markdown_content)
